...
var ProdudctPage = () => {
    ...
    let addToCard = async () => {
        ...
        if (!localStorage.getItem("eden-pa-user-uid")) {
            window.location = "/accessories/signin";
            return
        }
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-4 col-xl-6 product-details-container">
                            ...
                            <div style={{ display: 'flex', alignItems: "center" }} className="product-detail-item product-rating">Rating: <span style={{ width: "5px" }}></span>
                                <Rating value={parseInt(data.topRating)} size='large' readOnly/>
                                {/* {<RatingStars
                                    value={}
                                    size={24}
                                    count={5}
                            ...
                            <div className="product-detail-item buy-add-to-cart-btns">
                                <div className="product-add-to-cart-btn" onClick={addToCard}>Add to cart</div>
