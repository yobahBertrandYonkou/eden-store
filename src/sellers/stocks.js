    ...
    return (
        <div className="main-container">
            ...
            <div className="side-nav-links">
                ...
                <div className="side-nav-link stocks"><a className="active-side-link"  href=""> <i className="fa fa-layer-group"></i> Stocks</a></div>
        ...
        <div id="body-container">
            ...
            <div className="content-container">
                ...
                <div className="top-options-container">
                    ...
                    <div className="new-item-btn">Add item</div>
                </div>
