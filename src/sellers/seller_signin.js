                    ...
                    if(email.value.trim() === ""){
                        ...
                        .then( response => {
                            ...
                            if (response.status !== 200){
                                ...
                                localStorage.setItem("eden-sl-customer-count", response.data.customers === undefined ? 0 : response.data.customers.length);
                                localStorage.setItem("eden-sl-search-count", response.data.searches);
