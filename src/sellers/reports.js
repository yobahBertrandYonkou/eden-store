...
var Reports = () => {
    ...
    useEffect(() => {
        ...
        if (window.Chart.getChart("month-canvas") === undefined) {
        ...
        if (window.Chart.getChart("week-canvas") === undefined) {
        ...
        if (window.Chart.getChart("brand-sales") === undefined) {
        ...
        if (window.Chart.getChart("percentage-brand") === undefined) {
                    ...
                    <div className="container-fluid">
                        <div className="row">
                            ...
                            <div className="col-lg-4 right-side">
                                <div style={{ backgroundColor: "white" }} className="daily-stats recent-card col-12">
                                    <div className="daily-stats-header">
